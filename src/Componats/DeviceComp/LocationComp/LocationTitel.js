...
const LocationTitel = ({setOpen}) => {
    
    const handleClickOpen=()=>{
        setOpen(true);
    }
  return (
    <Card style={{ borderRadius: '15px',boxShadow:' 0 0 10px rgba(0, 0, 0, 0.2), 0 0 20px rgba(0, 0, 0, 0.1)',transition: 'transform 0.2s'}}>
    <CardActions>
